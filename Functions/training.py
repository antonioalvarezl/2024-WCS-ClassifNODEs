...
class  doublebackTrainer():
    ...
    def train(self, datatrain, max_epochs=30000, pathparams=''):
        ...
        self.best_score, self.model.best_epoch, self.model.best_param, last_saved_model = float('inf'), 0, 0., None
        ...
        for epoch in range(self.max_epochs):
            ...
            if score < self.best_score:
                self.best_score, self.model.best_epoch, self.model.best_param = score, epoch, self.model.state_dict()
